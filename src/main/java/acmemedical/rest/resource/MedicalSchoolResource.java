/*******************************************************************************************************
 * File:  MedicalSchoolResource.java
...
public class MedicalSchoolResource {
    ...
    @GET
    @RolesAllowed({ADMIN_ROLE, USER_ROLE}) // MSR01: Both admin and user allowed
    ...
    @DELETE
    @RolesAllowed({ADMIN_ROLE}) // MSR02: Only admin allowed to delete
    @Path("/{medicalSchoolId}")
